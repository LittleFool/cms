...
$().ready(function() {
    $('textarea.tinymce').tinymce({
        ...
        // Theme options
        theme_advanced_buttons1 : "bold,italic,underline,strikethrough,justifyleft,justifycenter,justifyright,justifyfull,fontselect,fontsizeselect|,visualblocks,code",
